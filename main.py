...
with open('../vefVerkefni7/index.html', 'w', encoding='utf-8') as file:
    file.write(index_html)

with open('../vefVerkefni7/bread.html', 'w') as file:
    file.write(bread_html)

with open('../vefVerkefni7/form.html', 'w') as file:
...
for post in POSTS:
    ...
    post_file_path = '../vefVerkefni7/posts/{slug}.html'.format(slug=post_metadata['slug'])
